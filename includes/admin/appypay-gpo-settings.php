...
return apply_filters(
	...
	[
		...
		'gpo_title'       => [
			...
			'default'     => __( 'Multicaixa Express', 'woocommerce-gateway-appypay' ),
			'desc_tip'    => true,
		],
		'gpo_description' => [
			...
			'default'     => __( 'You have 90 seconds to authorize the payment using Multicaixa Express associated to phone number provided.', 'woocommerce-gateway-appypay' ),
			'desc_tip'    => true,
		],
